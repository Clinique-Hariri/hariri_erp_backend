...
class InsuranceSocietiesApiController extends Controller
{
  ...
  public function index(Request $request)
  {
    ...
    try {
      ...
      return $this->successResponse(
        data: InsuranceSocietyResource::collection($model)
      );
    } catch (Throwable $e) {
  ...
  public function show($id)
  {
    ...
    try {
      $model = InsuranceSociety::findOrFail($id);

      return $this->successResponse(
        data: new InsuranceSocietyResource($model)
      );
    } catch (Throwable $e) {
      return $this->errorResponse($e->getMessage(), 500);
    }
  ...
  {
    $this->authorizePermission(PermissionNames::INSURANCE_SOCIETIES_CREATE);
    ...
    try {
      $model = InsuranceSociety::create($data);
  ...
  {
    $this->authorizePermission(PermissionNames::INSURANCE_SOCIETIES_DELETE);
