...
namespace Modules\Clinic\app\Http\Controllers;
...
class DoctorTransactionsApiController extends Controller
{
  ...
  public function index(Request $request, $doctorId)
  {
    ...
    try {
      $model = Doctor::findOrFail($doctorId)->transactions()
        ->with(['user', 'transactionable'])->orderBy('created_at', 'desc');
  ...
  public function show($doctorId, $id)
  {
    $this->authorizePermission(PermissionNames::DOCTORS_VIEW);
  ...
  public function updateStatus(Request $request, $doctorId, $id)
  {
    $this->authorizePermission([PermissionNames::DOCTORS_UPDATE, PermissionNames::ACCOUNTING_PAYMENT_TO_THE_DOCTOR]);
  ...
  public function multiUpdateStatus(Request $request, $doctorId)
  {
